...
SKELETON:  vcs skeleton <filepath> [start-end]              (Returns structural skeleton for JS/TS/Py/Rust/Go/Java/Rb)
...
UNDO:      vcs undo <filepath> [blob]                       (Roll back to a previous state)
